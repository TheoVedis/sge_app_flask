...
- value (list of string | numbers; optional):
    ...
    @_explicitize_args
    def __init__(self, id=..., options=..., value=..., className=..., style=..., inputStyle=..., inputClassName=..., labelStyle=..., labelClassName=..., loading_state=..., persistence=..., persisted_props=..., persistence_type=..., **kwargs) -> None:
        ...
