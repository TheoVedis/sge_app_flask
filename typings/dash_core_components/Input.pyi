...
- value (string | number; optional):
    ...
    @_explicitize_args
    def __init__(self, id=..., value=..., style=..., className=..., debounce=..., type=..., autoComplete=..., autoFocus=..., disabled=..., inputMode=..., list=..., max=..., maxLength=..., min=..., minLength=..., multiple=..., name=..., pattern=..., placeholder=..., readOnly=..., required=..., selectionDirection=..., selectionEnd=..., selectionStart=..., size=..., spellCheck=..., step=..., n_submit=..., n_submit_timestamp=..., n_blur=..., n_blur_timestamp=..., loading_state=..., persistence=..., persisted_props=..., persistence_type=..., **kwargs) -> None:
        ...
