...
- verticalHeight (number; default 400):
    ...
    @_explicitize_args
    def __init__(self, id=..., marks=..., value=..., drag_value=..., className=..., disabled=..., dots=..., included=..., min=..., max=..., tooltip=..., step=..., vertical=..., verticalHeight=..., updatemode=..., loading_state=..., persistence=..., persisted_props=..., persistence_type=..., **kwargs) -> None:
        ...
