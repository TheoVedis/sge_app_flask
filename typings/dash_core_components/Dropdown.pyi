...
- value (string | number | list of string | numbers; optional):
    ...
    @_explicitize_args
    def __init__(self, id=..., options=..., value=..., optionHeight=..., className=..., clearable=..., disabled=..., multi=..., placeholder=..., searchable=..., search_value=..., style=..., loading_state=..., persistence=..., persisted_props=..., persistence_type=..., **kwargs) -> None:
        ...
