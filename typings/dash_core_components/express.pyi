...
def send_file(path, filename=..., type=...):
    """
...
def send_bytes(src, filename, type=..., **kwargs):
    """
...
def send_string(src, filename, type=..., **kwargs):
    """
...
def send_data_frame(writer, filename, type=..., **kwargs):
    """
