...
- style (dict; optional):
    ...
    @_explicitize_args
    def __init__(self, id=..., responsive=..., clickData=..., clickAnnotationData=..., hoverData=..., clear_on_unhover=..., selectedData=..., relayoutData=..., extendData=..., prependData=..., restyleData=..., figure=..., style=..., className=..., animate=..., animation_options=..., config=..., loading_state=..., **kwargs) -> None:
        ...
