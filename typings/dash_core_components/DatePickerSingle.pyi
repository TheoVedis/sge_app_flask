...
- with_portal (boolean; default False):
    ...
    supported on vertical calendar."""
    @_explicitize_args
    def __init__(self, id=..., date=..., min_date_allowed=..., max_date_allowed=..., initial_visible_month=..., day_size=..., calendar_orientation=..., is_RTL=..., placeholder=..., reopen_calendar_on_clear=..., number_of_months_shown=..., with_portal=..., with_full_screen_portal=..., first_day_of_week=..., stay_open_on_select=..., show_outside_days=..., month_format=..., display_format=..., disabled=..., clearable=..., style=..., className=..., loading_state=..., persistence=..., persisted_props=..., persistence_type=..., **kwargs) -> None:
        ...
