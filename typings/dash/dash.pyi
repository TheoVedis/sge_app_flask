...
class Dash(object):
    ...
    clientside callback.
    """
    def __init__(self, name=..., server=..., assets_folder=..., assets_url_path=..., assets_ignore=..., assets_external_path=..., eager_loading=..., include_assets_files=..., url_base_pathname=..., requests_pathname_prefix=..., routes_pathname_prefix=..., serve_locally=..., compress=..., meta_tags=..., index_string=..., external_scripts=..., external_stylesheets=..., suppress_callback_exceptions=..., prevent_initial_callbacks=..., show_undo_redo=..., plugins=..., title=..., update_title=..., **obsolete) -> None:
        ...
    ...
    def csp_hashes(self, hash_algorithm=...):
    ...
    def enable_dev_tools(self, debug=..., dev_tools_ui=..., dev_tools_props_check=..., dev_tools_serve_dev_bundles=..., dev_tools_hot_reload=..., dev_tools_hot_reload_interval=..., dev_tools_hot_reload_watch_interval=..., dev_tools_hot_reload_max_retry=..., dev_tools_silence_routes_logging=..., dev_tools_prune_errors=...):
    ...
    def run_server(self, host=..., port=..., proxy=..., debug=..., dev_tools_ui=..., dev_tools_props_check=..., dev_tools_serve_dev_bundles=..., dev_tools_hot_reload=..., dev_tools_hot_reload_interval=..., dev_tools_hot_reload_watch_interval=..., dev_tools_hot_reload_max_retry=..., dev_tools_silence_routes_logging=..., dev_tools_prune_errors=..., **flask_run_options):
