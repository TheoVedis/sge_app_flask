...
np = ...
scipy_interp = ...
def create_ternary_contour(coordinates, values, pole_labels=..., width=..., height=..., ncontours=..., showscale=..., coloring=..., colorscale=..., linecolor=..., title=..., interp_mode=..., showmarkers=...):
    """
