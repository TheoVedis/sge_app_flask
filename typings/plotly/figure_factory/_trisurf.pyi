...
def trisurf(x, y, z, simplices, show_colorbar, edges_color, scale, colormap=..., color_func=..., plot_edges=..., x_edge=..., y_edge=..., z_edge=..., facecolor=...):
    """
    Refer to FigureFactory.create_trisurf() for docstring
    """
    ...

def create_trisurf(x, y, z, simplices, colormap=..., show_colorbar=..., scale=..., color_func=..., title=..., plot_edges=..., showbackground=..., backgroundcolor=..., gridcolor=..., zerolinecolor=..., edges_color=..., height=..., width=..., aspectratio=...):
    """
