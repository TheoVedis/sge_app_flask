...
def make_half_violin(x, y, fillcolor=..., linecolor=...):
    """
    Produces a sideways probability distribution fig violin plot.
    """
    ...

def make_violin_rugplot(vals, pdf_max, distance, color=...):
    """
...
def violinplot(vals, fillcolor=..., rugplot=...):
    """
...
def create_violin(data, data_header=..., group_header=..., colors=..., use_colorscale=..., group_stats=..., rugplot=..., sort=..., height=..., width=..., title=...):
    """
