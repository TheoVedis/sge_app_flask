...
class RadialAxis(_BaseLayoutHierarchyType):
    ...
    _mapped_properties = ...
    def __init__(self, arg=..., angle=..., autorange=..., autotypenumbers=..., calendar=..., categoryarray=..., categoryarraysrc=..., categoryorder=..., color=..., dtick=..., exponentformat=..., gridcolor=..., gridwidth=..., hoverformat=..., layer=..., linecolor=..., linewidth=..., minexponent=..., nticks=..., range=..., rangemode=..., separatethousands=..., showexponent=..., showgrid=..., showline=..., showticklabels=..., showtickprefix=..., showticksuffix=..., side=..., tick0=..., tickangle=..., tickcolor=..., tickfont=..., tickformat=..., tickformatstops=..., tickformatstopdefaults=..., ticklen=..., tickmode=..., tickprefix=..., ticks=..., ticksuffix=..., ticktext=..., ticktextsrc=..., tickvals=..., tickvalssrc=..., tickwidth=..., title=..., titlefont=..., type=..., uirevision=..., visible=..., **kwargs) -> None:
        """
