...
class AngularAxis(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg=..., autotypenumbers=..., categoryarray=..., categoryarraysrc=..., categoryorder=..., color=..., direction=..., dtick=..., exponentformat=..., gridcolor=..., gridwidth=..., hoverformat=..., layer=..., linecolor=..., linewidth=..., minexponent=..., nticks=..., period=..., rotation=..., separatethousands=..., showexponent=..., showgrid=..., showline=..., showticklabels=..., showtickprefix=..., showticksuffix=..., thetaunit=..., tick0=..., tickangle=..., tickcolor=..., tickfont=..., tickformat=..., tickformatstops=..., tickformatstopdefaults=..., ticklen=..., tickmode=..., tickprefix=..., ticks=..., ticksuffix=..., ticktext=..., ticktextsrc=..., tickvals=..., tickvalssrc=..., tickwidth=..., type=..., uirevision=..., visible=..., **kwargs) -> None:
        """
