...
class XAxis(_BaseLayoutHierarchyType):
    ...
    _mapped_properties = ...
    def __init__(self, arg=..., anchor=..., automargin=..., autorange=..., autotypenumbers=..., calendar=..., categoryarray=..., categoryarraysrc=..., categoryorder=..., color=..., constrain=..., constraintoward=..., dividercolor=..., dividerwidth=..., domain=..., dtick=..., exponentformat=..., fixedrange=..., gridcolor=..., gridwidth=..., hoverformat=..., layer=..., linecolor=..., linewidth=..., matches=..., minexponent=..., mirror=..., nticks=..., overlaying=..., position=..., range=..., rangebreaks=..., rangebreakdefaults=..., rangemode=..., rangeselector=..., rangeslider=..., scaleanchor=..., scaleratio=..., separatethousands=..., showdividers=..., showexponent=..., showgrid=..., showline=..., showspikes=..., showticklabels=..., showtickprefix=..., showticksuffix=..., side=..., spikecolor=..., spikedash=..., spikemode=..., spikesnap=..., spikethickness=..., tick0=..., tickangle=..., tickcolor=..., tickfont=..., tickformat=..., tickformatstops=..., tickformatstopdefaults=..., ticklabelmode=..., ticklabelposition=..., ticklen=..., tickmode=..., tickprefix=..., ticks=..., tickson=..., ticksuffix=..., ticktext=..., ticktextsrc=..., tickvals=..., tickvalssrc=..., tickwidth=..., title=..., titlefont=..., type=..., uirevision=..., visible=..., zeroline=..., zerolinecolor=..., zerolinewidth=..., **kwargs) -> None:
        """
