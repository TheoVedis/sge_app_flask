...
class Surface(_BaseTraceType):
    ...
    def __init__(self, arg=..., autocolorscale=..., cauto=..., cmax=..., cmid=..., cmin=..., coloraxis=..., colorbar=..., colorscale=..., connectgaps=..., contours=..., customdata=..., customdatasrc=..., hidesurface=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertemplate=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., legendgroup=..., lighting=..., lightposition=..., meta=..., metasrc=..., name=..., opacity=..., opacityscale=..., reversescale=..., scene=..., showlegend=..., showscale=..., stream=..., surfacecolor=..., surfacecolorsrc=..., text=..., textsrc=..., uid=..., uirevision=..., visible=..., x=..., xcalendar=..., xsrc=..., y=..., ycalendar=..., ysrc=..., z=..., zcalendar=..., zsrc=..., **kwargs) -> None:
        """
