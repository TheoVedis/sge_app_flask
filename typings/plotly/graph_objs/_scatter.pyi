...
class Scatter(_BaseTraceType):
    ...
    def __init__(self, arg=..., cliponaxis=..., connectgaps=..., customdata=..., customdatasrc=..., dx=..., dy=..., error_x=..., error_y=..., fill=..., fillcolor=..., groupnorm=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hoveron=..., hovertemplate=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., legendgroup=..., line=..., marker=..., meta=..., metasrc=..., mode=..., name=..., opacity=..., orientation=..., r=..., rsrc=..., selected=..., selectedpoints=..., showlegend=..., stackgaps=..., stackgroup=..., stream=..., t=..., text=..., textfont=..., textposition=..., textpositionsrc=..., textsrc=..., texttemplate=..., texttemplatesrc=..., tsrc=..., uid=..., uirevision=..., unselected=..., visible=..., x=..., x0=..., xaxis=..., xcalendar=..., xperiod=..., xperiod0=..., xperiodalignment=..., xsrc=..., y=..., y0=..., yaxis=..., ycalendar=..., yperiod=..., yperiod0=..., yperiodalignment=..., ysrc=..., **kwargs) -> None:
        """
