...
class Pointcloud(_BaseTraceType):
    ...
    def __init__(self, arg=..., customdata=..., customdatasrc=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., ids=..., idssrc=..., indices=..., indicessrc=..., legendgroup=..., marker=..., meta=..., metasrc=..., name=..., opacity=..., showlegend=..., stream=..., text=..., textsrc=..., uid=..., uirevision=..., visible=..., x=..., xaxis=..., xbounds=..., xboundssrc=..., xsrc=..., xy=..., xysrc=..., y=..., yaxis=..., ybounds=..., yboundssrc=..., ysrc=..., **kwargs) -> None:
        """
