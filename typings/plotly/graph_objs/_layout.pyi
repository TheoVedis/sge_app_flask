...
class Layout(_BaseLayoutType):
    ...
    _mapped_properties = ...
    def __init__(self, arg=..., activeshape=..., angularaxis=..., annotations=..., annotationdefaults=..., autosize=..., autotypenumbers=..., bargap=..., bargroupgap=..., barmode=..., barnorm=..., boxgap=..., boxgroupgap=..., boxmode=..., calendar=..., clickmode=..., coloraxis=..., colorscale=..., colorway=..., computed=..., datarevision=..., direction=..., dragmode=..., editrevision=..., extendfunnelareacolors=..., extendpiecolors=..., extendsunburstcolors=..., extendtreemapcolors=..., font=..., funnelareacolorway=..., funnelgap=..., funnelgroupgap=..., funnelmode=..., geo=..., grid=..., height=..., hiddenlabels=..., hiddenlabelssrc=..., hidesources=..., hoverdistance=..., hoverlabel=..., hovermode=..., images=..., imagedefaults=..., legend=..., mapbox=..., margin=..., meta=..., metasrc=..., modebar=..., newshape=..., orientation=..., paper_bgcolor=..., piecolorway=..., plot_bgcolor=..., polar=..., radialaxis=..., scene=..., selectdirection=..., selectionrevision=..., separators=..., shapes=..., shapedefaults=..., showlegend=..., sliders=..., sliderdefaults=..., spikedistance=..., sunburstcolorway=..., template=..., ternary=..., title=..., titlefont=..., transition=..., treemapcolorway=..., uirevision=..., uniformtext=..., updatemenus=..., updatemenudefaults=..., violingap=..., violingroupgap=..., violinmode=..., waterfallgap=..., waterfallgroupgap=..., waterfallmode=..., width=..., xaxis=..., yaxis=..., **kwargs) -> None:
        """
