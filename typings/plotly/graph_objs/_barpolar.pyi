...
class Barpolar(_BaseTraceType):
    ...
    def __init__(self, arg=..., base=..., basesrc=..., customdata=..., customdatasrc=..., dr=..., dtheta=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertemplate=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., legendgroup=..., marker=..., meta=..., metasrc=..., name=..., offset=..., offsetsrc=..., opacity=..., r=..., r0=..., rsrc=..., selected=..., selectedpoints=..., showlegend=..., stream=..., subplot=..., text=..., textsrc=..., theta=..., theta0=..., thetasrc=..., thetaunit=..., uid=..., uirevision=..., unselected=..., visible=..., width=..., widthsrc=..., **kwargs) -> None:
        """
