...
class Cone(_BaseTraceType):
    ...
    def __init__(self, arg=..., anchor=..., autocolorscale=..., cauto=..., cmax=..., cmid=..., cmin=..., coloraxis=..., colorbar=..., colorscale=..., customdata=..., customdatasrc=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertemplate=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., legendgroup=..., lighting=..., lightposition=..., meta=..., metasrc=..., name=..., opacity=..., reversescale=..., scene=..., showlegend=..., showscale=..., sizemode=..., sizeref=..., stream=..., text=..., textsrc=..., u=..., uid=..., uirevision=..., usrc=..., v=..., visible=..., vsrc=..., w=..., wsrc=..., x=..., xsrc=..., y=..., ysrc=..., z=..., zsrc=..., **kwargs) -> None:
        """
