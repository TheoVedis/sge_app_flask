...
class Table(_BaseTraceType):
    ...
    def __init__(self, arg=..., cells=..., columnorder=..., columnordersrc=..., columnwidth=..., columnwidthsrc=..., customdata=..., customdatasrc=..., domain=..., header=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., ids=..., idssrc=..., meta=..., metasrc=..., name=..., stream=..., uid=..., uirevision=..., visible=..., **kwargs) -> None:
        """
