...
class Volume(_BaseTraceType):
    ...
    def __init__(self, arg=..., autocolorscale=..., caps=..., cauto=..., cmax=..., cmid=..., cmin=..., coloraxis=..., colorbar=..., colorscale=..., contour=..., customdata=..., customdatasrc=..., flatshading=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertemplate=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., isomax=..., isomin=..., legendgroup=..., lighting=..., lightposition=..., meta=..., metasrc=..., name=..., opacity=..., opacityscale=..., reversescale=..., scene=..., showlegend=..., showscale=..., slices=..., spaceframe=..., stream=..., surface=..., text=..., textsrc=..., uid=..., uirevision=..., value=..., valuesrc=..., visible=..., x=..., xsrc=..., y=..., ysrc=..., z=..., zsrc=..., **kwargs) -> None:
        """
