...
class Scatterpolargl(_BaseTraceType):
    ...
    def __init__(self, arg=..., connectgaps=..., customdata=..., customdatasrc=..., dr=..., dtheta=..., fill=..., fillcolor=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertemplate=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., legendgroup=..., line=..., marker=..., meta=..., metasrc=..., mode=..., name=..., opacity=..., r=..., r0=..., rsrc=..., selected=..., selectedpoints=..., showlegend=..., stream=..., subplot=..., text=..., textfont=..., textposition=..., textpositionsrc=..., textsrc=..., texttemplate=..., texttemplatesrc=..., theta=..., theta0=..., thetasrc=..., thetaunit=..., uid=..., uirevision=..., unselected=..., visible=..., **kwargs) -> None:
        """
