...
class Candlestick(_BaseTraceType):
    ...
    def __init__(self, arg=..., close=..., closesrc=..., customdata=..., customdatasrc=..., decreasing=..., high=..., highsrc=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., increasing=..., legendgroup=..., line=..., low=..., lowsrc=..., meta=..., metasrc=..., name=..., opacity=..., open=..., opensrc=..., selectedpoints=..., showlegend=..., stream=..., text=..., textsrc=..., uid=..., uirevision=..., visible=..., whiskerwidth=..., x=..., xaxis=..., xcalendar=..., xperiod=..., xperiod0=..., xperiodalignment=..., xsrc=..., yaxis=..., **kwargs) -> None:
        """
