...
class Splom(_BaseTraceType):
    ...
    def __init__(self, arg=..., customdata=..., customdatasrc=..., diagonal=..., dimensions=..., dimensiondefaults=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertemplate=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., legendgroup=..., marker=..., meta=..., metasrc=..., name=..., opacity=..., selected=..., selectedpoints=..., showlegend=..., showlowerhalf=..., showupperhalf=..., stream=..., text=..., textsrc=..., uid=..., uirevision=..., unselected=..., visible=..., xaxes=..., yaxes=..., **kwargs) -> None:
        """
