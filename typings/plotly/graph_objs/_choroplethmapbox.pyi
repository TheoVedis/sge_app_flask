...
class Choroplethmapbox(_BaseTraceType):
    ...
    def __init__(self, arg=..., autocolorscale=..., below=..., coloraxis=..., colorbar=..., colorscale=..., customdata=..., customdatasrc=..., featureidkey=..., geojson=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertemplate=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., legendgroup=..., locations=..., locationssrc=..., marker=..., meta=..., metasrc=..., name=..., reversescale=..., selected=..., selectedpoints=..., showlegend=..., showscale=..., stream=..., subplot=..., text=..., textsrc=..., uid=..., uirevision=..., unselected=..., visible=..., z=..., zauto=..., zmax=..., zmid=..., zmin=..., zsrc=..., **kwargs) -> None:
        """
