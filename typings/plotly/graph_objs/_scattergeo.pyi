...
class Scattergeo(_BaseTraceType):
    ...
    def __init__(self, arg=..., connectgaps=..., customdata=..., customdatasrc=..., featureidkey=..., fill=..., fillcolor=..., geo=..., geojson=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertemplate=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., lat=..., latsrc=..., legendgroup=..., line=..., locationmode=..., locations=..., locationssrc=..., lon=..., lonsrc=..., marker=..., meta=..., metasrc=..., mode=..., name=..., opacity=..., selected=..., selectedpoints=..., showlegend=..., stream=..., text=..., textfont=..., textposition=..., textpositionsrc=..., textsrc=..., texttemplate=..., texttemplatesrc=..., uid=..., uirevision=..., unselected=..., visible=..., **kwargs) -> None:
        """
