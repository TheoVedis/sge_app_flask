...
class Heatmapgl(_BaseTraceType):
    ...
    def __init__(self, arg=..., autocolorscale=..., coloraxis=..., colorbar=..., colorscale=..., customdata=..., customdatasrc=..., dx=..., dy=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., ids=..., idssrc=..., meta=..., metasrc=..., name=..., opacity=..., reversescale=..., showscale=..., stream=..., text=..., textsrc=..., transpose=..., uid=..., uirevision=..., visible=..., x=..., x0=..., xaxis=..., xsrc=..., xtype=..., y=..., y0=..., yaxis=..., ysrc=..., ytype=..., z=..., zauto=..., zmax=..., zmid=..., zmin=..., zsmooth=..., zsrc=..., **kwargs) -> None:
        """
