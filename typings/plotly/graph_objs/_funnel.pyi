...
class Funnel(_BaseTraceType):
    ...
    def __init__(self, arg=..., alignmentgroup=..., cliponaxis=..., connector=..., constraintext=..., customdata=..., customdatasrc=..., dx=..., dy=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertemplate=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., insidetextanchor=..., insidetextfont=..., legendgroup=..., marker=..., meta=..., metasrc=..., name=..., offset=..., offsetgroup=..., opacity=..., orientation=..., outsidetextfont=..., selectedpoints=..., showlegend=..., stream=..., text=..., textangle=..., textfont=..., textinfo=..., textposition=..., textpositionsrc=..., textsrc=..., texttemplate=..., texttemplatesrc=..., uid=..., uirevision=..., visible=..., width=..., x=..., x0=..., xaxis=..., xperiod=..., xperiod0=..., xperiodalignment=..., xsrc=..., y=..., y0=..., yaxis=..., yperiod=..., yperiod0=..., yperiodalignment=..., ysrc=..., **kwargs) -> None:
        """
