...
class Scatter3d(_BaseTraceType):
    ...
    def __init__(self, arg=..., connectgaps=..., customdata=..., customdatasrc=..., error_x=..., error_y=..., error_z=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertemplate=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., legendgroup=..., line=..., marker=..., meta=..., metasrc=..., mode=..., name=..., opacity=..., projection=..., scene=..., showlegend=..., stream=..., surfaceaxis=..., surfacecolor=..., text=..., textfont=..., textposition=..., textpositionsrc=..., textsrc=..., texttemplate=..., texttemplatesrc=..., uid=..., uirevision=..., visible=..., x=..., xcalendar=..., xsrc=..., y=..., ycalendar=..., ysrc=..., z=..., zcalendar=..., zsrc=..., **kwargs) -> None:
        """
