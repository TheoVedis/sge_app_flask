...
class Choropleth(_BaseTraceType):
    ...
    def __init__(self, arg=..., autocolorscale=..., coloraxis=..., colorbar=..., colorscale=..., customdata=..., customdatasrc=..., featureidkey=..., geo=..., geojson=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertemplate=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., legendgroup=..., locationmode=..., locations=..., locationssrc=..., marker=..., meta=..., metasrc=..., name=..., reversescale=..., selected=..., selectedpoints=..., showlegend=..., showscale=..., stream=..., text=..., textsrc=..., uid=..., uirevision=..., unselected=..., visible=..., z=..., zauto=..., zmax=..., zmid=..., zmin=..., zsrc=..., **kwargs) -> None:
        """
