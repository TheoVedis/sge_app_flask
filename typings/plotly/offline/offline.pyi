...
def init_notebook_mode(connected=...):
    """
...
def iplot(figure_or_data, show_link=..., link_text=..., validate=..., image=..., filename=..., image_width=..., image_height=..., config=..., auto_play=..., animation_opts=...):
    """
...
def plot(figure_or_data, show_link=..., link_text=..., validate=..., output_type=..., include_plotlyjs=..., filename=..., auto_open=..., image=..., image_filename=..., image_width=..., image_height=..., config=..., include_mathjax=..., auto_play=..., animation_opts=...):
...
def plot_mpl(mpl_fig, resize=..., strip_style=..., verbose=..., show_link=..., link_text=..., validate=..., output_type=..., include_plotlyjs=..., filename=..., auto_open=..., image=..., image_filename=..., image_height=..., image_width=...):
    """
...
def iplot_mpl(mpl_fig, resize=..., strip_style=..., verbose=..., show_link=..., link_text=..., validate=..., image=..., image_filename=..., image_height=..., image_width=...):
    """
...
def enable_mpl_offline(resize=..., strip_style=..., verbose=..., show_link=..., link_text=..., validate=...):
    """
