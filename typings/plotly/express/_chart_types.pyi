...
def density_contour(data_frame=..., x=..., y=..., z=..., color=..., facet_row=..., facet_col=..., facet_col_wrap=..., facet_row_spacing=..., facet_col_spacing=..., hover_name=..., hover_data=..., animation_frame=..., animation_group=..., category_orders=..., labels=..., orientation=..., color_discrete_sequence=..., color_discrete_map=..., marginal_x=..., marginal_y=..., trendline=..., trendline_color_override=..., log_x=..., log_y=..., range_x=..., range_y=..., histfunc=..., histnorm=..., nbinsx=..., nbinsy=..., title=..., template=..., width=..., height=...):
    """
...
def line(data_frame=..., x=..., y=..., line_group=..., color=..., line_dash=..., hover_name=..., hover_data=..., custom_data=..., text=..., facet_row=..., facet_col=..., facet_col_wrap=..., facet_row_spacing=..., facet_col_spacing=..., error_x=..., error_x_minus=..., error_y=..., error_y_minus=..., animation_frame=..., animation_group=..., category_orders=..., labels=..., orientation=..., color_discrete_sequence=..., color_discrete_map=..., line_dash_sequence=..., line_dash_map=..., log_x=..., log_y=..., range_x=..., range_y=..., line_shape=..., render_mode=..., title=..., template=..., width=..., height=...):
    """
...
def line_3d(data_frame=..., x=..., y=..., z=..., color=..., line_dash=..., text=..., line_group=..., hover_name=..., hover_data=..., custom_data=..., error_x=..., error_x_minus=..., error_y=..., error_y_minus=..., error_z=..., error_z_minus=..., animation_frame=..., animation_group=..., category_orders=..., labels=..., color_discrete_sequence=..., color_discrete_map=..., line_dash_sequence=..., line_dash_map=..., log_x=..., log_y=..., log_z=..., range_x=..., range_y=..., range_z=..., title=..., template=..., width=..., height=...):
    """
...
def line_ternary(data_frame=..., a=..., b=..., c=..., color=..., line_dash=..., line_group=..., hover_name=..., hover_data=..., custom_data=..., text=..., animation_frame=..., animation_group=..., category_orders=..., labels=..., color_discrete_sequence=..., color_discrete_map=..., line_dash_sequence=..., line_dash_map=..., line_shape=..., title=..., template=..., width=..., height=...):
    """
...
def line_polar(data_frame=..., r=..., theta=..., color=..., line_dash=..., hover_name=..., hover_data=..., custom_data=..., line_group=..., text=..., animation_frame=..., animation_group=..., category_orders=..., labels=..., color_discrete_sequence=..., color_discrete_map=..., line_dash_sequence=..., line_dash_map=..., direction=..., start_angle=..., line_close=..., line_shape=..., render_mode=..., range_r=..., range_theta=..., log_r=..., title=..., template=..., width=..., height=...):
    """
...
def bar_polar(data_frame=..., r=..., theta=..., color=..., hover_name=..., hover_data=..., custom_data=..., base=..., animation_frame=..., animation_group=..., category_orders=..., labels=..., color_discrete_sequence=..., color_discrete_map=..., color_continuous_scale=..., range_color=..., color_continuous_midpoint=..., barnorm=..., barmode=..., direction=..., start_angle=..., range_r=..., range_theta=..., log_r=..., title=..., template=..., width=..., height=...):
    """
...
def line_geo(data_frame=..., lat=..., lon=..., locations=..., locationmode=..., geojson=..., featureidkey=..., color=..., line_dash=..., text=..., facet_row=..., facet_col=..., facet_col_wrap=..., facet_row_spacing=..., facet_col_spacing=..., hover_name=..., hover_data=..., custom_data=..., line_group=..., animation_frame=..., animation_group=..., category_orders=..., labels=..., color_discrete_sequence=..., color_discrete_map=..., line_dash_sequence=..., line_dash_map=..., projection=..., scope=..., center=..., fitbounds=..., basemap_visible=..., title=..., template=..., width=..., height=...):
    """
...
def density_mapbox(data_frame=..., lat=..., lon=..., z=..., hover_name=..., hover_data=..., custom_data=..., animation_frame=..., animation_group=..., category_orders=..., labels=..., color_continuous_scale=..., range_color=..., color_continuous_midpoint=..., opacity=..., zoom=..., center=..., mapbox_style=..., radius=..., title=..., template=..., width=..., height=...):
    """
...
def line_mapbox(data_frame=..., lat=..., lon=..., color=..., text=..., hover_name=..., hover_data=..., custom_data=..., line_group=..., animation_frame=..., animation_group=..., category_orders=..., labels=..., color_discrete_sequence=..., color_discrete_map=..., zoom=..., center=..., mapbox_style=..., title=..., template=..., width=..., height=...):
    """
...
def scatter_matrix(data_frame=..., dimensions=..., color=..., symbol=..., size=..., hover_name=..., hover_data=..., custom_data=..., category_orders=..., labels=..., color_discrete_sequence=..., color_discrete_map=..., color_continuous_scale=..., range_color=..., color_continuous_midpoint=..., symbol_sequence=..., symbol_map=..., opacity=..., size_max=..., title=..., template=..., width=..., height=...):
    """
...
def parallel_coordinates(data_frame=..., dimensions=..., color=..., labels=..., color_continuous_scale=..., range_color=..., color_continuous_midpoint=..., title=..., template=..., width=..., height=...):
    """
...
def parallel_categories(data_frame=..., dimensions=..., color=..., labels=..., color_continuous_scale=..., range_color=..., color_continuous_midpoint=..., title=..., template=..., width=..., height=..., dimensions_max_cardinality=...):
    """
...
def pie(data_frame=..., names=..., values=..., color=..., color_discrete_sequence=..., color_discrete_map=..., hover_name=..., hover_data=..., custom_data=..., labels=..., title=..., template=..., width=..., height=..., opacity=..., hole=...):
    """
...
def sunburst(data_frame=..., names=..., values=..., parents=..., path=..., ids=..., color=..., color_continuous_scale=..., range_color=..., color_continuous_midpoint=..., color_discrete_sequence=..., color_discrete_map=..., hover_name=..., hover_data=..., custom_data=..., labels=..., title=..., template=..., width=..., height=..., branchvalues=..., maxdepth=...):
    """
...
def treemap(data_frame=..., names=..., values=..., parents=..., ids=..., path=..., color=..., color_continuous_scale=..., range_color=..., color_continuous_midpoint=..., color_discrete_sequence=..., color_discrete_map=..., hover_name=..., hover_data=..., custom_data=..., labels=..., title=..., template=..., width=..., height=..., branchvalues=..., maxdepth=...):
    """
...
def funnel_area(data_frame=..., names=..., values=..., color=..., color_discrete_sequence=..., color_discrete_map=..., hover_name=..., hover_data=..., custom_data=..., labels=..., title=..., template=..., width=..., height=..., opacity=...):
    """
