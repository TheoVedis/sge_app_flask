...
class OrcaConfig(object):
    ...
    def restore_defaults(self, reset_server=...):
        """
...
def to_image(fig, format=..., width=..., height=..., scale=..., validate=...):
    """
...
def write_image(fig, file, format=..., scale=..., width=..., height=..., validate=...):
    """
