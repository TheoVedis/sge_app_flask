...
def to_image(fig, format=..., width=..., height=..., scale=..., validate=..., engine=...):
    """
...
def write_image(fig, file, format=..., scale=..., width=..., height=..., validate=..., engine=...):
    """
...
def full_figure_for_development(fig, warn=..., as_dict=...):
    """
