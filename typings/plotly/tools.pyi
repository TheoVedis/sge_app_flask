...
sage_salvus = ...
def mpl_to_plotly(fig, resize=..., strip_style=..., verbose=...):
...
def get_subplots(rows=..., columns=..., print_grid=..., **kwargs):
...
def make_subplots(rows=..., cols=..., shared_xaxes=..., shared_yaxes=..., start_cell=..., print_grid=..., **kwargs):
