...
- value (string; optional):
    ...
    page load."""
    @_explicitize_args
    def __init__(self, children=..., id=..., n_clicks=..., n_clicks_timestamp=..., key=..., role=..., autoFocus=..., disabled=..., form=..., formAction=..., formEncType=..., formMethod=..., formNoValidate=..., formTarget=..., name=..., type=..., value=..., accessKey=..., className=..., contentEditable=..., contextMenu=..., dir=..., draggable=..., hidden=..., lang=..., spellCheck=..., style=..., tabIndex=..., title=..., loading_state=..., **kwargs) -> None:
        ...
