...
- title (string; optional):
    ...
    @_explicitize_args
    def __init__(self, children=..., id=..., n_clicks=..., n_clicks_timestamp=..., key=..., role=..., autoPlay=..., controls=..., crossOrigin=..., loop=..., muted=..., preload=..., src=..., accessKey=..., className=..., contentEditable=..., contextMenu=..., dir=..., draggable=..., hidden=..., lang=..., spellCheck=..., style=..., tabIndex=..., title=..., loading_state=..., **kwargs) -> None:
        ...
